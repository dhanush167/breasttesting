    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">@lang('crud.checklists.index_title')</h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.checklists.inputs.name')
                            </th>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2">{!! $checklists->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
