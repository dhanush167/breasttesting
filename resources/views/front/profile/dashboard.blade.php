...
@section('content')
  ...
  <!-- Start main-content -->
    ...
    <section class="inner-header divider layer-overlay overlay-white-8" data-bg-img="{{ asset('images/bg/bg6.jpg') }}">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8">
              <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" class="active"><a href="#orders" aria-controls="orders" role="tab" data-toggle="tab" class="font-15 text-uppercase">Bookings <span class="badge">4</span></a></li>
