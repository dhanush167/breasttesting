...
<!-- Mirrored from kodesolution.com/html/2016/medikal-html/demo/form-appointment-style1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Oct 2022 09:22:00 GMT -->
<head>
          ...
          <nav id="menuzord-right" class="menuzord blue bg-lightest">
            ...
            <ul class="menuzord-menu">
                ...
                <ul class="dropdown">
                  ...
                  <li><a href="#">Boxed Layouts</a>
                    <ul class="dropdown">
                      ...
                      <li><a href="index-boxed-mp-layout8.html">Boxed Multi Page Layout8</a></li>
                  ...
                  <li><a href="#">RTL Layouts</a>
                    <ul class="dropdown">
                      ...
                      <li><a href="index-rtl-mp-layout8.html">RTL Multi Page Layout8</a></li>
              ...
              <li><a href="#">Departments</a>
                <ul class="dropdown">
                  <li><a href="page-services-details.html">Outpatient Depertment</a></li>
                  <li><a href="page-services-details.html">Cardiology Depertment</a></li>
                  <li><a href="page-services-details.html">Neurology Depertment</a></li>
                  <li><a href="page-services-details.html">Personal Depertment</a></li>
                  <li><a href="page-services-details.html">Dental Depertment</a></li>
                  <li><a href="page-services-details.html">Haematology Depertment</a></li>
                </ul>
              </li>
              <li><a href="#">Doctors</a>
                <ul class="dropdown">
                  <li><a href="page-doctors-style1.html">Doctors Style 1</a></li>
                  <li><a href="page-doctors-style2.html">Doctors Style 2</a></li>
        ...
        <div class="row">
          <div class="col-md-6 col-md-push-3">
            <div class="border-1px p-25">
              ...
              <form id="appointment_form" name="appointment_form" class="mt-30" method="post" action="https://kodesolution.com/html/2016/medikal-html/demo/includes/appointment.php">
                <div class="row">
                  <div class="col-sm-12">
